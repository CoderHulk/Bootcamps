...
const BootcampSchema = new mongoose.Schema({
    ...
    slug: String,
    //Devcentral Bootcamp -> slug will be "devcentral-bootcamp"
    description: {
        type: String,
        required: [true, 'Description can not be more than 500 characters']
    },
    website: {
        type: String,
...
BootcampSchema.pre('save', async function(next){
    ...
    // do not save user address which is send by user
